                ...
                <nav className="w-full flex justify-between gap-6 relative">
                   ...
                   {/* toggle button */}
                    <div className="min-w-max flex items-center gap-x-3">
                        <button
                            onClick={toggleTheme}
                            className={`outline-none flex relative text-heading-2 rounded-full p-2 lg:p-3 cursor-pointer bg-[#7f22fe] ${theme === "dark" ? "border border-transparent" : "border border-box-border"
                                }`}
                        >
                            {theme === "dark" ? (
                                <svg
